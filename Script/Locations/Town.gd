...
func _ready() -> void:
	...
	$Passage/RailwayStation/PointLight2D.hide()
...
func _on_railway_station_mouse_entered() -> void:
	$Passage/RailwayStation/PointLight2D.show()


func _on_railway_station_mouse_exited() -> void:
	$Passage/RailwayStation/PointLight2D.hide()
